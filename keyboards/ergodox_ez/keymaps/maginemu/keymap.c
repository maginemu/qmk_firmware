 ...
 * |        |      |      |      |      |      |      |      |      |      |      |      |      |      |        |
 * `--------+------+------+------+------+-------------'      `-------------+------+------+------+------+--------'
 *   |LAlt  |  '"  |AltShf| Esc  |LGui  |                                  | RGui | RAlt |      |      | Enter  |
 *   |      |      |      | / L1 |      |                                  |      |      |      |      |        |
 *   `----------------------------------'                                  `------------------------------------'
 *                                        ,-------------.  ,---------------.
 *                                        | Esc  | PgUp |  | PgUp |  Ctrl  |
...
[BASE] = LAYOUT_ergodox(  // layer 0 : default
        ...
        TG(L3),    KC_QUOT,  KC_NO,   KC_LALT, KC_LGUI,

                   KC_ESC,       KC_PGUP,
                                 KC_PGDN,
        KC_LCTL,  LT(L2, KC_SPC), KC_TAB,
        ...
        KC_RGUI,  KC_RALT,KC_DOWN, KC_UP,   KC_ENT,

        KC_PGUP,  CTL_T(KC_ESC),
        KC_PGDN,
        KC_BSPC,  KC_SPC, LT(L1, KC_ENT)
    ),
...
[L2] = LAYOUT_ergodox(
    ...
    // right hand
       _______,     _______, _______, _______, _______, _______, _______,
       S(KC_LBRC),  _______, _______, _______, _______, _______, _______,
                    S(KC_6), S(KC_7), S(KC_8), S(KC_9), S(KC_0), _______,
       S(KC_RBRC),  _______, _______, _______, _______, _______, _______,
                             _______, _______, _______, _______, _______,
       _______, _______,
       _______,
       _______, _______, _______
