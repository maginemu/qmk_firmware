 ...
 * `--------+------+------+------+------+-------------'      `-------------+------+------+------+------+--------'
 *   |Fn    |  '"  |AltShf| LAlt |LGui  |                                  | RGui | LEFT | DOWN | UP   | Right/L1|
 *   `----------------------------------'                                  `----------------------------------'
 *                                        ,-------------.  ,---------------.
...
[BASE] = LAYOUT_ergodox(  // layer 0 : default
        ...
        KC_LALT,  KC_QUOT,  KC_LEFT, LT(L1,KC_ESC), KC_LGUI,
        ...
        KC_RGUI,     LT(L1, KC_LEFT),KC_DOWN, KC_UP,     KC_RIGHT,
...
[L1] = LAYOUT_ergodox(
    ...
    // right hand
       ...
       KC_LPRN,  KC_6   , KC_7,    KC_8,    KC_9,     KC_0,    KC_F12,
                 KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT, _______, _______,
       KC_RPRN,  _______, _______, _______, _______,  _______, _______,
...
[L3] = LAYOUT_ergodox(
    ...
    // right hand
       ...
       _______,  _______, _______, KC_MPRV, KC_MNXT, _______, _______,
                          KC_WBAK, _______, _______, _______, _______,
       _______, _______,
       _______,
       _______, _______, _______
),
